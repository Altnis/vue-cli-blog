        ...
        <div class="conte">
            ...
            <div class="resetqu">
                ...
                <ul class="regnav">
                    ...
                    <li id="zcbtn"><a style="color: #1f1f1f;" href="#/reset"><b>重置密码</b></a></li>
                </ul>
                <div class="zccont">
                    <div class="zcleft">
                        <div class="zcmes">*重置密码</div>
                    </div>
                    <div class="message">
                        <label for="user">登录用户名:</label><input id="user" type="text"><br>
                        <div style="height:4px;"></div>                                           
                        <label for="email">邮 箱:</label><input id="email" type="text"><br>
                        <div style="height:4px;"></div>
                        <label for="yzm">验 证 码:</label><input id="yzm" type="text">                        
                    </div>
                    <div class="return">
                        <button><a href="">找回</a></button>
                    </div>
                </div>
            </div>
        </div>
